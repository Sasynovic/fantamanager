...
// Validazione input
    ...
    try {
        ...
        $requiredFields = ['id_squadra_attuale', 'id_squadra_nuova', 'id_calciatore', 'costo_calciatore'];
        ...
        $result = $associazioni->switch(
            $data->id_squadra_attuale,
            $data->id_squadra_nuova,
            $data->id_calciatore,
            $data->costo_calciatore
        );
    if ($result) {
