...
require_once __DIR__ . '/../../models/stadio.php';
...
try {
    ...
    if ($result) {
        ...
        echo json_encode([
            "success" => false,
            "message" => "Nessuna stadio trovata con questo ID o nessun cambiamento applicato.",
            "status" => "error"
        ]);
    }
